...
{{< notice info "Hinweis" >}}
 _Die Registrierung der E-POSTBUSINESS API ist kostenlos. Es werden lediglich, wie üblich, Portokosten fällig. [Aktuelle E-POSTBUSINESS API Versandkosten](/files/dp_prices_01012025.pdf). Die Portokosten rechnet die Deutsche Post mit Ihnen direkt ab._
{{< /notice >}}
######
