...
Das veröffentlichen der Connector 365 Base & Easy Document Pin App erfolgt via der **Business Central Administration Shell**. Transferieren Sie zunächst die von uns an Sie gesendete Dateien auf dem Server auf dem Ihre Business Central Instanz läuft.
...
Sie können nun mit der [Einrichtung](/de-de/apps/easydocumentpin/first-steps/setup/) starten.
